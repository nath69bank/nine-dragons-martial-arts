...
import { Users, Award, BookOpen, Apple } from 'lucide-react'

interface Stats { members: number; belts: number; lessons: number; nutrition: number }

export default function AdminOverview() {
  const [stats, setStats] = useState<Stats>({ members: 0, belts: 0, lessons: 0, nutrition: 0 })
